...
public class AnswerBut : MonoBehaviour
{
    ...
    void Update()
    {
        if (scoreValue4 >= 140)
        {
            feedback4.GetComponent<Text>().text = "Συγχαρητήρια!";
        }
        else if (scoreValue4 < 140 && scoreValue4 >= 100)
        {
            feedback4.GetComponent<Text>().text = "Καλή προσπάθεια!";
        }
        else if (scoreValue4 < 100)
        {
            feedback4.GetComponent<Text>().text = "Προσπάθησε  ξανά! ";
        }
        else
        {
            feedback4.GetComponent<Text>().text = " ";
        }
    ...
    public void AnswerD()
    {
        ...
        else
        {
            ...
            else if (QuestionGene.actualAnswer4 == "Β")
            {
                answerBbackGreen4.SetActive(true);
                answerBbackBlue4.SetActive(false);
            }
            else if (QuestionGene.actualAnswer4 == "Γ")
            {
    ...
    public void AnswerC()
    {
        ...
        else
        {
            ...
            else if (QuestionGene.actualAnswer4 == "Δ")
            {
                answerDbackGreen4.SetActive(true);
                answerDbackBlue4.SetActive(false);
            }
